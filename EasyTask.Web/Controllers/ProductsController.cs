...
namespace EasyTask.Web.Controllers
{
    public class ProductsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,ProductName,Price,Category,Unidad,Fecha_Registro,Path_Imagen")] Producto producto)
        {
